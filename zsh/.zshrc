...
export ZSH="/home/castares/.oh-my-zsh"
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/castares/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/castares/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/castares/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
