...
local mappings = {
	...
	l = {
		...
		t = { "<cmd>Telescope lsp_type_definitions theme=ivy<CR>", "Type Definition" },
		d = { "<cmd>Telescope lsp_definitions theme=ivy<CR>", "Definition" },
		D = { "<cmd>lua vim.lsp.buf.declaration()<CR>", "Declaration" },
		a = { "<cmd>lua vim.lsp.buf.code_action()<cr>", "Code Action" },
		f = { "<cmd>lua vim.lsp.buf.format()<cr>", "Format" },
		i = { "<cmd>Telescope lsp_implementation theme=ivy<CR>", "Implementation" },
	...
	s = {
		...
		d = { "<cmd>Telescope lsp_diagnostics bufnr=0<cr>", "File Diagnostics in Telescope" },
