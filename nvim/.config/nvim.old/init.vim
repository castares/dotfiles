...
" Paths:
let g:python3_host_prog = expand("~/.conda/envs/neovim/bin/python3.9")
let g:node_host_prog = expand("~/.fnm/node-versions/v16.14.2/installation/bin/neovim-node-host")
